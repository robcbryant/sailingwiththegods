...
//		}
	...
	public string GetJobClassEquivalency (int jobCode)
	{
		...
		case GV_CONST.CREWTYPE_SLAVE:
			title = "Slave";
			break;
		case GV_CONST.CREWTYPE_PASSENGER:
			title = "Passenger";
			break;
		case GV_CONST.CREWTYPE_NAVIGATOR:
			title = "Navigator";
			break;
		case GV_CONST.CREWTYPE_ASSISTANT:
			title = "Assistant";
			break;
		case GV_CONST.CREWTYPE_GUIDE:
			title = "Guide";
			break;
		case GV_CONST.CREWTYPE_LAWYER:
			title = "Lawyer";
			break;
		case GV_CONST.CREWTYPE_ROYALTY:
			title = "Royalty";
			break;
	...
	public string GetCloutTitleEquivalency (int clout)
	{
		...
		if (clout > 0 && clout <= 10)
			title = "The Unknown";
		else if (clout > 10 && clout <= 20)
			title = "The Insignificant";
		else if (clout > 20 && clout <= 30)
			title = "The Lesser Known";
		else if (clout > 30 && clout <= 40)
			title = "The Common";
		else if (clout > 40 && clout <= 50)
			title = "The Known";
		else if (clout > 50 && clout <= 60)
			title = "The Well Known";
		else if (clout > 60 && clout <= 70)
			title = "The Respected";
		else if (clout > 70 && clout <= 80)
			title = "The Famed";
		else if (clout > 80 && clout <= 95)
			title = "The Heroic";
		else if (clout > 95 && clout <= 100)
			title = "The Legendary";
		else
			title = "ERROR: clout is not between 0 and 100";
	...
	public string GetPlayerCloutTitleEquivalency (int clout)
	{
		...
		if (clout > 1 && clout <= 499)
			title = "Goatherd";
		else if (clout > 500 && clout <= 999)
			title = "Farmer";
		else if (clout > 1000 && clout <= 1499)
			title = "Merchant";
		else if (clout > 1500 && clout <= 1999)
			title = "Mercenary";
		else if (clout > 2000 && clout <= 2499)
			title = "Knight";
		else if (clout > 2500 && clout <= 2999)
			title = "War Chief";
		else if (clout > 3000 && clout <= 3499)
			title = "Leader of the Boule";
		else if (clout > 3500 && clout <= 3999)
			title = "Ambassador";
		else if (clout > 4000 && clout <= 4499)
			title = "Prince";
		else if (clout > 4500 && clout <= 4999)
			title = "King";
		else if (clout >= 5000)
			title = "The God";
		else
